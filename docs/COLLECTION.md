...
Version 0.7.0 supplies four bounded collectors. The existing 21 parsers remain available for offline exports; a parser does not imply a live collector. Collection, ingestion and verification use zero model tokens.
