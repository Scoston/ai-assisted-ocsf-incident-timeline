...
The Databricks source notebooks in `integrations/databricks/` use workspace `spark` and `dbutils` objects. They are deployed/imported into Databricks, while these three `.ipynb` files also work in local Jupyter.
